...
{
	// use_renderer++;
	// if (use_renderer >= static_cast<int>(R_MAX))
	// 	use_renderer = 0;

	// use_renderer = static_cast<RENDERERS>(use_renderer + 1);
	// if (use_renderer >= R_MAX)
	// 	use_renderer = 0;

	use_renderer = static_cast<RENDERERS>((static_cast<int>(use_renderer) + 1) % (static_cast<int>(R_MAX) + 1));
}
